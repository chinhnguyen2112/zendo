...
$s = date('s', $tgian);
?>
<link rel="stylesheet" href="/assets/css/sanacc/css_vq_new.css?v=1">
<div id="main">
    <div class="content">
        <div class="div_close">
            ...
            <div class="box-left">
                <div class="header-title">
                    <div class="get-free-spin" onclick="show_popup(5)">
                        ...
                        <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/gift.svg" alt="gift">
                        <div class="text">
                            <p>
                    ...
                    <div class="list_box_vp vp_1">
                        <div class="box_vip_1">
                            <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/vp_acc.png" alt="tay cầm chơi game" style="margin-top: 32%;">
                            <!-- <p>Acc V.I.P</p> -->
                        </div>
                        <div class="box_vip_2">
                            <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/vp_qh.png" alt="bao tay chơi game" style="margin-top: 40%; margin-left:21%">
                            <!-- <p>1000</p> -->
                        </div>
                        <div class="box_vip_3">
                            <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/vp_skin.png" alt="tai nge chơi game" style="margin-top: 32%;">
                            <!-- <p>Acc thường</p> -->
                        </div>
                ...
                <div class="rotation_box">
                    <div class="spin-img">
                        <img class="img_spin_img lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/vq_random.png" alt="rotation">
                        <div class="muiten_quay">
                            <img class="img_muiten lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/muiten.png" alt="Mũi tên">
                        </div>
                        <img  src="/images/load.gif" data-src="/images/sanacc/vqlq/center_vq.png" class="img_rank_center lazyload" alt="vòng quay">
                    </div>
                    <div class="text-spin">
                        <div class="box_count_turn">
                            <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/count_turn.png" alt="lượt quay">
    ...
    <div class="box_noti_gif popup_happy">
        <div class="body_gif" style="background: url(/images/sanacc/vqlq/img_bgr_tb.png);background-size: 100% 100%; position:relative;width:600px">
                ...
                <div class="body_gif_nav">
                    <div class="div_img_noti" style=" display:block;min-height: 220px;">
                        <div class="box_this_gif">
                            <img class="img_gif_this lazyload" style="margin-top: 30px;width: 25%;" src="/images/load.gif" data-src="" alt="phần thưởng">
                        </div>
                    </div>
            ...
            <img style="width:50px; position:absolute;top:-10px;right:-1px" class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/dong_tb.png" onclick="$('.popup_happy').hide();" alt="đóng">
        </div>
    </div>
    <!-- popup lịch sử quay -->
                        ...
                        <div class="div_img_noti">
                            <div class="box_left_img">
                                <div class="box_img_free">
                                    <img class="img-small lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/star.svg" alt="chúc mừng">
                                </div>
                                <div class="box_img_free">
                                    <img class="img_big lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/star.svg" alt="chúc mừng">
                                </div>
                            </div>
                            <div class="box_left_img">
                                <div class="box_img_free">
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        ...
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Acc Liên quân từ 8-50 tướng.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">50-1000 quân huy</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">50 Zen.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Voucher giảm 100.000đ khi mua acc từ 500.000đ.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Skin bậc A - bậc SS.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Phiếu phần thưởng.</p>
                        <p class="nav_nav_cac_buoc"><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Mảnh ghép skin.</p>
    ...
    <div class="box_noti_gif popup_nhiem_vu">
        <div class="body_gif">
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <div class="box_text_noti">
                        <p><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Giới thiệu 1 bạn chơi mới nhận ngay 1 lượt quay vòng quay nhiệm vụ.</span></p>
                        <p><img class="img_box_uudai lazyload" src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Đăng kí ngay kênh <a target="_blank" href="https://www.youtube.com/channel/UCGPEASI3zLBeuAlaDZVP_gw/featured">Zendo Shop</a> của Zendo để nhận ngay 4 lượt quay nhiệm vụ.</p>
                        <p><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Khi mua acc từ 200.000đ được tặng 1 lượt quay tự chọn.</p>
                        <p><img class="img_box_uudai lazyload" src="/images/load.gif" data-src="/images/sanacc/detail/send.svg" alt="ưu đãi 1">Tích điểm sau mỗi lần mua acc, đủ 20 điểm khách hàng sẽ được tặng 1 lượt quay tự chọn.</p>
                    </div>
                </div>
            </div>
            <div class="box_close_gif">
    ...
    <div style="display: none;" class="popup_buy_spin">
        <div class="body_buy_spin">
            <img onclick="$('.popup_buy_spin').hide();" class="close_buy_spin lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/dong_tb.png" alt="close_popup">
            <div class="buy_spin_container">
                ...
                <div class="box_buy_spin">
                    <div class="left_box">
                        <img class="lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/vq_random.png" alt="popup">
    ...
    <div class="box_noti_gif popup_error">
        <div class="body_gif">
            ...
            <div class="body_noti_gif">
                <div class="body_gif_nav">
                    <img class="img_error lazyload" src="/images/load.gif" data-src="/images/sanacc/vqlq/error.svg" alt="lỗi">
                    <div class="box_text_noti_gif">
                        <div class="type_gif">
...
<script src="/assets/js/core/jquery.min.js"></script>
    ...
    <script src="/assets/slider/freshslider.min.js"></script>
<?php
