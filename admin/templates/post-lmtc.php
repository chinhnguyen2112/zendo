        ...
        <div class="tab-pane active" id="lmht">
            ...
            <form id="data" method="post" enctype="multipart/form-data" class="form-horizontal push-5-t" novalidate="novalidate">
                ...
                <div class="form-group">
                    ...
                    <!--        </option>-->
                    <!--        <option value="Liên Minh Huyền Thoại Hàn">-->
                    <!--            Liên Minh Huyền Thoại Hàn-->
                    <!--        </option>-->
                    ...
                    <!--</div>-->
                     <div class="form-group">
                        <label class="col-xs-12" for="note">Giá bán<b data-toggle="tooltip" data-placement="right" title="Hiển thị ở trang chủ khi để chuột vào"><i class="fa fa-question-circle"></i></b></label>
                        <div class="col-xs-12">
