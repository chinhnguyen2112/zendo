...
<input type="radio" name="type_account" value="FIFA Random 20k" > FIFA Random 20k<br>
<input type="radio" name="type_account" value="FIFA Random 50k" > FIFA Random 50k<br>
<input type="radio" name="type_account" value="FIFA Random 100k" > FIFA Random 100k<br>
<input type="radio" name="type_account" value="FIFA Random 200k" > FIFA Random 200k<br>
...
if ($user && $data_user['admin'] > 0) {
    ...
    foreach($result as $key => $value){
        ...
        if ($type_account=="FIFA Random 20k"){
             $price = 20000;
             $check_page =  27;
         }
          else if ($type_account=="FIFA Random 50k"){
             $price = 50000;
             $check_page =  28;
         }
          else if ($type_account=="FIFA Random 100k"){
             $price = 100000;
             $check_page =  29;
         }
          else if ($type_account=="FIFA Random 200k"){
             $price = 200000;
             $check_page =  30;
         }
