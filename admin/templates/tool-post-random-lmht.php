...
<input type="radio" name="type_account" value="Liên Minh Huyền Thoại Random 9k" > Liên Minh Huyền Thoại Random 9k<br>
<input type="radio" name="type_account" value="Liên Minh Huyền Thoại Random 20k" > Liên Minh Huyền Thoại Random 20k<br>
<input type="radio" name="type_account" value="Liên Minh Huyền Thoại Random 50k" > Liên Minh Huyền Thoại Random 50k<br>
<input type="radio" name="type_account" value="Liên Minh Huyền Thoại Random 100k" > Liên Minh Huyền Thoại Random 100k<br>
<input type="radio" name="type_account" value="Liên Minh Huyền Thoại Random 200k" > Liên Minh Huyền Thoại Random 200k<br>
