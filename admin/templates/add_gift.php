        ...
        <div class="gray">
            <table width="100%">
                ...
                <tr class="second">
                    ...
                    <input id="image" name="image" class="fileupload img_random" onchange="preview_image(event, this);" type="file"></td>
                </tr>
                <tr class="second">
                    <td><strong>Type</strong></td>
                     <td><select type="number" name="type" value="<?= (isset($row_gift))? $row_gift['type'] : '' ; ?>">
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay')?  "selected" : '' ?> value="luotquay">Liên quân 1k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay9k')?  "selected" : '' ?> value="luotquay9k">Liên quân 9k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay20k')?  "selected" : '' ?> value="luotquay20k">Liên quân 20k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay50k')?  "selected" : '' ?> value="luotquay50k">Liên quân 50k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay100k')?  "selected" : '' ?> value="luotquay100k">Liên quân 100k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay200k')?  "selected" : '' ?> value="luotquay200k">Liên quân 200k</option>
                    <option <?= (isset($row_gift) && $row_gift['type']== 'luotquay500k')?  "selected" : '' ?> value="luotquay500k">Liên quân 500k</option>
                    </select></td>
                </tr>
                <tr class="second">
