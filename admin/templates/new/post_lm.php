...
<div class="col-sm-7 col-sm-pull-5 col-lg-8 col-lg-pull-4">
  ...
  <div class="block block-themed">
    ...
    <ul class="nav nav-tabs nav-tabs-alt tit_lmht" data-toggle="tabs">
      <li class="active">
        <a href="#lmht">LIÊN MINH HUYỀN THOẠI</a>
      </li>
    </ul>
        ...
        <form id="data" method="post" enctype="multipart/form-data" class="form-horizontal push-5-t" novalidate="novalidate">
          ...
          <div class="form-group flex_center space_bet mb20">
            <div class="col-xs-4"><label for="rank">Rank</label>
              <select class="form-control" name="rank">
                ...
                <option value="8">Đại cao thủ</option>
            ...
            <div class="col-xs-4"><label for="frame">Khung</label>
              <select class="form-control" name="frame">
                ...
                <option value="1">Khung Sắt</option>
                <option value="2">Khung Bạc</option>
                <option value="3">Khung Vàng</option>
                <option value="4">Khung Bạch Kim</option>
                <option value="5">Khung Kim Cương</option>
                <option value="6">Khung Thách Đấu</option>
                <option value="7">Khung Cao Thủ</option>
                <option value="8">Khung Đại Cao Thủ</option>
                <option value="9">Khung Thách Đấu</option>
              </select>
            </div>
          ...
          <div class="col-xs-12"><label for="type_account">Loại Nick</label>
            <select class="form-control" name="source" id="source">
              <option value="0">Liên Minh Huyền Thoại Việt</option>
              <option value="1">Liên Minh Huyền Thoại Hàn Quốc</option>
              <option value="2">Liên Minh Huyền Thoại NA</option>
              <option value="3">Liên Minh Huyền Thoại PBE</option>
