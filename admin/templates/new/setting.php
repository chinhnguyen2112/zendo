...
<div class="container-scroller">
  <div class="block block-themed">
    <div class="block-header bg-info">
      <h3 class="block-title">CÀI ĐẶT CHUNG</h3>
    </div>
    <div class="block-content padding_chung">
          ...
          <div class="col-xs-12">
            <label class="css-input switch switch-sm switch-success">
              <?php if ($data_web['status'] == '0') : ?>
                <input type="checkbox" id="status" name="status" value="1"> <span>Mở giao dịch</span>
              <?php else : ?>
                <input type="checkbox" id="status" name="status" value="0"> <span>Bảo trì trang web</span>
              <?php endif; ?>
            </label>
          </div>
        </div>
