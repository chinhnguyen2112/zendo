...
$sql_blog = "SELECT * FROM chuyenmuc";
$count = $db->fetch_assoc($sql_blog, 0);
?>
<div class="add_blog padding_chung">
    <h3 class="header mb20">Thêm bài viết</h3>
            ...
            <div class="gray">
                <table width="100%">
                    ...
                    <tr class="second">
                        ...
                        <td><select name="category" id="category">
                                <?php foreach ($count as $key => $val) { ?>
                                    <option <?php if($row['chuyenmuc'] == $val['id']) {
                                        echo 'selected';
                                    }else {
                                        echo '';
                    ...
                    <tr class="second">
                        ...
                        <input hidden name="images" value="<?= (isset($row)) ? $row['image'] : ''; ?>">
                    </tr>
