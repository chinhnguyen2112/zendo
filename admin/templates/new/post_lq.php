...
<div class="page-content" style="min-height: 355px; ">
  <script>
  ...
  <div class="portlet light bordered">
    <ul class="nav nav-tabs nav-tabs-alt tit_lmht mb20" data-toggle="tabs">
      <li class="active">
        <a class="ml50" href="#lmht">ĐĂNG LIÊN QUÂN</a>
      </li>
    </ul>

    <div class="portlet-body form padding_chung">
      <form id="lq" action="" method="POST" enctype="multipart/form-data">

        <h4 class="mb20"><b>Thông tin tài khoản</b></h4>

        <div class="form-body">
          <div class="main_info_row">
            <div class="col-xs-4 w33 pr20 mb20">
            ...
            <div class="col-xs-4 w33 mb20">
              <div class="form-group">
                ...
                <select class="form-control" name="type_post">
                  ...
                  <option value="4"> Acc chưa định giá</option>
                </select>
              </div>
            </div>
          </div>
          <div class="col-xs-12">
            ...
            <div class="col-xs-6 mb20">
              <label for="thumb">Ảnh minh hoạ (chỉ chọn ảnh jpg)</label>
              <div class="form-group">
                <div class="currency-input"><input accept="image/jpg" class="currency form-control" type="file" name="thumb"></div>
              </div>
            </div>
            <div class="col-xs-6 mb20">
              <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select id="champ" name="champ[]" class="form-control select2-multiple m-b-20 selectiamges" multiple onchange="count_champ(this);">
                ...
                <option value="81" data-img-src="/assets/data/8/champ/81.jpg">Yan</option>
...
<script>
  $('#submitlq').click(function() {
    $('#submitlq').text('Đang xử lý');
  })
