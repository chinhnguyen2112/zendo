...
<div class="col-sm-7 col-sm-pull-5 col-lg-8 col-lg-pull-4">
    <div class="block block-themed">
        ...
        <ul class="nav nav-tabs nav-tabs-alt tit_lmht" data-toggle="tabs">
            <li class="active">
                <a href="#lmht">ĐĂNG ACC PUBG MOBILE</a>
            </li>
        </ul>
                ...
                <form id="data" method="post" enctype="multipart/form-data" class="form-horizontal push-5-t" novalidate="novalidate">
                    ...
                    <div class="form-group flex_center mb20">
                        <div class="col-xs-6 pr20">
                            <label for="skins_count">Số skin trang phục</label>
                            <input class="form-control" type="number" id="skins_count" name="skins_count" placeholder="">
                        </div>
                        <div class="col-xs-6">
                            <label for="champs_count">Số skin súng</label>
                            <input class="form-control" type="champs_count" id="champs_count" name="champs_count" placeholder="">
                        </div>

                    </div>
                    <div class="form-group mb20">
                        <label class="col-xs-12" for="skins">Nhập danh sách tên Trang phục <b data-toggle="tooltip" data-placement="right" title="" data-original-title="Phẩy để xuống dòng"><i class="fa fa-question-circle"></i></b></label>
                        <div class="col-xs-12">
                    ...
                    <div class="form-group mb20">
                        <label class="col-xs-12" for="champs">Nhập danh sách tên skin súng <b data-toggle="tooltip" data-placement="right" title="" data-original-title="Phẩy xuống dòng"><i class="fa fa-question-circle"></i></b></label>
                        <div class="col-xs-12">
                    ...
                    <div class="form-group flex_center space_bet mb20">
                        <div class="col-xs-4 w33 pr20"><label for="signup">Đăng ký</label>
                            <select class="form-control" name="signup">
                                ...
                                <option value="2">Play game</option>
                                <option value="3">Play center</option>
                            </select>
                        </div>
                        <div class="col-xs-4 w33 pr20"><label for="rank">Rank</label>
                            <select class="form-control" name="rank">
                                ...
                                <option value="8">Quán quân</option>
                                <option value="9">Chí tôn</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group mb20">
                            <label class="col-xs-12" for="data">Ảnh thông tin<b data-toggle="tooltip" data-placement="right" title="" data-original-title="Mỗi ảnh sẽ là một bảng ngọc, có thể up nhiều ảnh"></b></label>
                            <div class="col-xs-12">
