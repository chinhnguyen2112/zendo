...
<form id="data" method="post">
  ...
  <div class="form-group padding_chung">
    <div class="col-xs-12">
      ...
      <input class="mb10" type="radio" name="type_account" value="FIFA Random 20k"> FIFA Random 20k<br>
      <input class="mb10" type="radio" name="type_account" value="FIFA Random 50k"> FIFA Random 50k<br>
      <input class="mb10" type="radio" name="type_account" value="FIFA Random 100k"> FIFA Random 100k<br>
      <input class="mb10" type="radio" name="type_account" value="FIFA Random 200k"> FIFA Random 200k<br>
