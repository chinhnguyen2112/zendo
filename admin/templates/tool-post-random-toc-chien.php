...
<input type="radio" name="type_account" value="Liên Minh Tốc Chiến Random 20k" > Liên Minh Tốc Chiến Random 20k<br>
<input type="radio" name="type_account" value="Liên Minh Tốc Chiến Random 50k" > Liên Minh Tốc Chiến Random 50k<br>
<input type="radio" name="type_account" value="Liên Minh Tốc Chiến Random 100k" > Liên Minh Tốc Chiến Random 100k<br>
...
if ($user && $data_user['admin'] > 0) {
    ...
    foreach($result as $key => $value){
        ...
        $type_account = $_POST['type_account'];
         if ($type_account=="Liên Minh Tốc Chiến Random 20k"){
             $price = 20000;
             $check_page =11;
         }
          else if ($type_account=="Liên Minh Tốc Chiến Random 50k"){
             $price = 50000;
             $check_page = 12;
         }
          else if ($type_account=="Liên Minh Tốc Chiến Random 100k"){
             $price = 100000;
             $check_page = 12;
         }
