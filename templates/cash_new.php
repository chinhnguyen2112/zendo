...
<ul class="nav nav-tabs nav-tabs-alt" style="max-width: 500px;margin: auto;" data-toggle="tabs">
<li class="active">
...
<div class="block-content tab-content">
 ...
 <div class="tab-pane fade" id="atm">
                <div style="display: block;" class="list_atm">
                    <p class="bank">Ngân hàng: <b>Techcombank</b></p>
                    <p class="bank">Chủ tài khoản: <b>Chu Thi Ngoc Anh</b></p>
                    <p class="bank">Số tài khoản: <b>1902.9151.126.668</b></p>
                    <p class="bank">Ví Momo: <b>CHU THỊ NGỌC ANH - 0976615309</b></p>
...
<div class ="">
   ...
   Khuyến mãi 10% cho các giao dịch Momo hoặc ATM.<br>
