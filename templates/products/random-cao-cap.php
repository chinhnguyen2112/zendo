...
<section class="content homepage content-boxed">
                 ...
                 <div style="display: block;" class="fitler">
                    <div class="content-search">
                      <h1 style="text-align:center;font-size:20px;margin:0;">Bán Acc Liên Quân 75k</h1>
                      <br>
                      <p>100% trắng thông tin, chắc chắn acc có 20 tướng trở lên, 20% acc lớn hơn 30 tướng, tối đa là 60 tướng
                 ...
                 <hr style="border-top:2px solid #1fc31d !important;">
                      ...
                      <h2 style="color:#313131;text-align:center;font-size:16px;margin:0;">Danh sách acc liên quân 75k</h2>
               </div>
    ...
    <script src="/assets/js/jquery-ui.min.js"></script>
        ...
        <script>
            ...
            function load_account(){
                $(".list_account").hide();
                $("#loading").show();
                $.post("../assets/ajax/random-cao-cap.php", { status : status , min_price : min_price , max_price : max_price , int_1 : int_1 , int_2 : int_2 , int_3 : int_3 , int_4 : int_4 , int_5 : int_5 , int_6 : int_6 , high_light : high_light , varchar_1 : varchar_1 , varchar_2 : varchar_2 , varchar_3 : varchar_3 , varchar_4 : varchar_4 , varchar_5 : varchar_5 , longtext_1 : longtext_1 , longtext_2 : longtext_2 , longtext_3 : longtext_3 , server : server , page : page })
                .done(function(data) {
                    $(".list_account").html('');
