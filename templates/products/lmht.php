                ...
                <div class="box_price">
                    ...
                    <div class="content_search">
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="0" name="viet" id="viet" class="source_signup">
                            <span>Server Việt</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="1" name="han" id="han" class="source_signup">
                            <span>Server Hàn Quốc</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="2" name="na" id="na" class="source_signup">
                            <span>Server NA</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="3" name="pbe" id="pbe" class="source_signup">
