        ...
        <div class="body_list">
            <div class="box_fillter">
                ...
                <div class="box_price">
                    ...
                    <div class="content_search">
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="0" name="facebook" id="facebook" class="source_signup">
                            <span>Facebook</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="1" name="vkontakate" id="vkontakate" class="source_signup">
