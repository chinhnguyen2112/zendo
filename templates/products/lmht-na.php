...
<?php 
$sql_1 = "SELECT * FROM setting_random  WHERE page ='lmht-na'";
    ...
    <section class="content homepage content-boxed">
        ...
        <div class="content cnt_list">
            ...
            <div style="display: block;" class="fitler">
                <div class="content-search">
                    <h1 style="font-size:20px;margin:0;"><b class="" style="color:#FFF">Acc Liên Minh Huyền Thoại Server NA</b></h1>
                    <div class="c_box_dm">
        ...
        <script>
            ...
            function load_account(){
                $(".list_account").hide();
                $("#loading").show();
                $.post("../assets/ajax/lmht-na.php", { status : status , min_price : min_price , max_price : max_price , int_1 : int_1 , int_2 : int_2 , int_3 : int_3 , int_4 : int_4 , int_5 : int_5 , int_6 : int_6 , high_light : high_light , varchar_1 : varchar_1 , varchar_2 : varchar_2 , varchar_3 : varchar_3 , varchar_4 : varchar_4 , varchar_5 : varchar_5 , longtext_1 : longtext_1 , longtext_2 : longtext_2 , longtext_3 : longtext_3 , server : server , page : page })
                .done(function(data) {
                    $(".list_account").html('');
