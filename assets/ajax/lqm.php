...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
    ...
    $ms= !empty($_POST['max_price']) ? (int)$_POST['ms'] : 0;
    $ngoc = !empty($_POST['max_price']) ? (int)$_POST['ngoc'] : 0;
...
<li>
    <div class="flip-container"> 
        <div class="flipper"><a href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" titel = "xem chi tiết acc ">
            <div class="front">
    ...
    <div class="phone_account_list">
        <a href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" titel = "xem chi tiết acc ">
