...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
   ...
   if ($gia == -1) $gia = 0;
    ...
    $total_record = $db->fetch_row("SELECT COUNT(id_post) FROM posts WHERE
      status = 0 AND
      type_account = 'Liên Quân Mobile Random Cao Cấp' AND
        ...
        <div class="flipper">
            <div class="front">
                <div class="account_image">
                    <img src="https://lienquanmobile.vn/assets/img/thu-van-may-75k.png" />
...
<ul>
<?php
  $sql_get_ads = "SELECT * FROM posts WHERE status ='0' AND type_post = '1' AND type_account = 'Liên Quân Mobile Random Cao Cấp' ORDER BY RAND() DESC LIMIT 5";
