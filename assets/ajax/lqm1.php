...
<?php
   $sql_get_list_acc1 = "SELECT * FROM posts WHERE
      status = 0 AND
      type_account = 'Liên Quân Mobile' AND
      type_post = 2 LIMIT 5";
?>
        ...
        <div class="flipper">
            <div class="front">
                ...
                <div class="account_info">
                    ...
                    <p><?php echo $data_post['ip_count']; ?> Ngọc</p>
            ...
            <div class="back">
                <div class="account_detail">
                    ...
                    <div class="button_div">
                        <a style="color: white;" href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" titel = "xem chi tiết acc " ><button>Xem chi tiết</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="phone_account_list">
        ...
        <div class="account_detail">
            <?php echo str_replace("\n", "</p>\n<p>", '<p>'.$data_post["note"].'</p>'); ?>            <div class="button_div">
                <a style="color: black;" href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" ><button>Xem chi tiết</button></a>
            </div>
        </div>
    </div>
</li>
        ...
        <div class="flipper">
            ...
            <div class="back">
                <div class="account_detail">
                    ...
                    <?php echo str_replace("\n", "</p>\n<p>", '<p>'.$data_post["note"].'</p>'); ?>
                    <div class="button_div">
                        <a style="color: white;" href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" ><button>Xem chi tiết</button></a>
                    </div>
                </div>
            </div>
        </div>
