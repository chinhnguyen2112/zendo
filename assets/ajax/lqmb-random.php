...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
   ...
   if ($gia == -1) $gia = 0;
    ...
    $total_record = $db->fetch_row("SELECT COUNT(id_post) FROM posts WHERE
      status = 0 AND
      type_account = 'Liên Quân Mobile Random 9K' AND
...
?>
<ul>
<li style="color:#FFF;width: 100%;float:none;text-align:center;font-size:16px;text-transform: uppercase;margin:0;">Không có tài khoản phù hợp với điều kiện tìm kiếm</li>
<br /><br /><br />
</ul>
<ul>
<li style="color:#FFF;width: 100%;float:none;text-align:center;font-size:16px;text-transform: uppercase;margin:0;">ACCOUNT QUẢNG CÁO</li>
