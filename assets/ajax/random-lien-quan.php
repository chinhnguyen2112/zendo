...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
   ...
   if ($gia == -1) $gia = 0;
    ...
    $total_record = $db->fetch_row("SELECT COUNT(id_post) FROM posts WHERE
      status = 0 AND
      type_account = 'Liên Quân Mobile Random' AND
...
<li>
        ...
        <div class="flipper">
            <div class="front">
                <div class="account_image">
                    ...
                    <img src="https://lienquanmobile.vn/assets/img/acc-trang-random.png" />
                ...
                <div class="account_info">
                   Acc trắng thông tin + ngẫu nhiên giá trị ( 10 % acc vip )
            ...
            <div class="back">
                <div class="account_detail">
                    ...
                    <div class="button_div">
                        <a style="color: white;" href="/tai-khoan-<?php echo $data_post['id_post']; ?>.html" titel = "xem chi tiết acc " target="_blank"><button>Xem chi tiết</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="phone_account_list">
        ...
        <div class="account_info">
           Acc Random chỉ với 9000 vnd ( 10% acc vip + 25% acc trắng ).
