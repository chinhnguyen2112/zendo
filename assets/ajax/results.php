...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
    ...
    if(!empty($_POST['longtext_1'])){
    $value = trim($_POST['longtext_1']);
   ...
   if ($gia == -1) $gia = 0;
    ...
    $total_record = $db->fetch_row("SELECT COUNT(id_post) FROM posts WHERE
      status = 0 AND
      type_account = 'Liên Minh Huyền Thoại' AND
        ...
        <div class="flipper">
            <div class="front">
                ...
                <div class="account_info">
                    ...
                    <p><?php echo $data_post['ip_count']; ?> IP</p>
            ...
            <div class="back">
                <div class="account_detail">
                    ...
                    <div class="button_div">
                        <a style="color: white;" href="/acc-<?php echo $data_post['id_post']; ?>" titel = "xem chi tiết acc " target="_blank"><button>Xem chi tiết</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="phone_account_list">
        ...
        <div class="account_detail">
            <?php echo str_replace("\n", "</p>\n<p>", '<p>'.$data_post["note"].'</p>'); ?>            <div class="button_div">
                <a style="color: black;" href="/acc-<?php echo $data_post['id_post']; ?>" target="_blank"><button>Xem chi tiết</button></a>
            </div>
        </div>
    </div>
</li>
...
<ul>
<?php
  $sql_get_ads = "SELECT * FROM posts WHERE status ='0' AND type_post = '1' AND type_account = 'Liên Minh Huyền Thoại' ORDER BY RAND() DESC LIMIT 5";
        ...
        <div class="flipper">
            ...
            <div class="back">
                <div class="account_detail">
                    ...
                    <?php echo str_replace("\n", "</p>\n<p>", '<p>'.$data_post["note"].'</p>'); ?>
                    <div class="button_div">
                        <a style="color: white;" href="/acc-<?php echo $data_post['id_post']; ?>" target="_blank"><button>Xem chi tiết</button></a>
                    </div>
                </div>
            </div>
        </div>
