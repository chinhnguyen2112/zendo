...
$(".li_type_lq").click(function () {
  if (type_play != $(this).data("type")) {
    ...
    if (type_play == "luotquay") {
      $(".img_spin_img").attr("src", "/images/sanacc/vqlq/vq_acc.png");
      //
      $(".buy_by_zen").show();
      $(".buy_spin_btn").css({
        display: "flex",
      ...
      $(".img_spin_img").attr("src", "/images/sanacc/vqlq/vq_qh.png");
      //
      $(".buy_by_zen").hide();
      $(".buy_spin_btn").css({
        display: "flex",
      ...
      $(".img_spin_img").attr("src", "/images/sanacc/vqlq/vq_skin.png");
      //
      $(".buy_by_zen").hide();
      $(".buy_spin_btn").css({
        display: "flex",
      ...
      $(".img_spin_img").attr("src", "/images/sanacc/vqlq/vq_random.png");
      //
      $(".buy_spin_btn").hide();
