...
require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/core/init.php');
            	...
            	$partner_id = '7187268751'; //API key, lấy từ website thesieure.vn thay vào trong cặp dấu '
            	$partner_key = 'ec8cb730ae7a6ec45f1bcaec306b819d'; //API secret lấy từ website thesieure.vn thay vào trong cặp dấu '
