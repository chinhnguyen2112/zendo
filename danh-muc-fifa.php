...
$sql_count_tc = "SELECT id_post FROM posts  WHERE type_account ='FIFA'";
$count_tc = $db->num_rows($sql_count_tc);

$sql_count_tc_20k = "SELECT id_post FROM posts  WHERE type_account ='FIFA Random 20k'";
$count_tc_20k = $db->num_rows($sql_count_tc_20k);

$sql_count_tc_50k = "SELECT id_post FROM posts  WHERE type_account ='FIFA Random 50k'";
$count_tc_50k = $db->num_rows($sql_count_tc_50k);

$sql_count_tc_100k = "SELECT id_post FROM posts  WHERE type_account ='FIFA Random 100k'";
...
<div class="content_shop">
    <div class="breadcrumbs">
        ...
        <span class="breadcrumb_page">Shop acc FIFA</span>
    </div>
